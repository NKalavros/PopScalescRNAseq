...
# ------------------------------- Configuration ---------------------------------
BASE_DIR = '/gpfs/scratch/nk4167/BreastAtlas'  # Adjust as needed
STUDIES = '''Bassez           Klughammer_snRNA  Tietscher
Chen        Gray              Kumar             Wu  Klughammer_scRNA  Pal '''
...
DEBUG_N_CELLS = 20000  # Number of cells to subsample per study in debug mode
                ...
                if not clean_obsms:
                    ...
                    try:
                        ...
                        if os.path.exists(figures_dir):
                            gdrive_path = 'GDrive:BreastAtlas/interstudy_figures/'
